        ...
        return (
            <View style={styles.contain}>
                ...
                <View style={styles.styWrapBtn}>
                    ...
                    <TouchableOpacity style={[styles.styBtn, { backgroundColor: '#28A745' }]} onPress={this.props.screenProps.goback}>
